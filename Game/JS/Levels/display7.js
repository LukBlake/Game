...
wood1.src = "img/forest/wood1.png";
wood2.src = "img/forest/wood2.png";
wood3.src = "img/forest/wood3.png";
...
box.src = "img/Castle/box1.png";
floorimg.src = "img/forest/lvl2/floor.png";
blockleft.src = "img/forest/obs1.png";
waterimg.src = "img/forest/water.png";
blockright.src = "img/forest/obs2.png";
var player = {
	xPrev: 0,
	yPrev: 0,
	width: 30,
...
//Соблюдение границ канваса по x
	...
	//Переход на следующий уровень
  	if ((player.x + player.width)>= 960) {
		window.location.replace("lvl8.php");
		move=0;
	}
};
...
var draw = function () {
	...
	context.drawImage(wood2, block2.x, block2.y, block2.width, block2.height);
	context.fillRect(block3.x, block3.y, block3.width, block3.height);
	context.drawImage(wood3, block3.x, block3.y, block3.width, block3.height);
	...
	context.drawImage(waterimg, water.x, water.y, water.width, water.height);
	context.fillRect(obstacle2.x, obstacle2.y, obstacle2.width, obstacle2.height);
	context.drawImage(blockright, obstacle2.x, obstacle2.y, obstacle2.width, obstacle2.height);
	context.fillRect(obstacle.x, obstacle.y, obstacle.width, obstacle.height);
	context.drawImage(blockleft, obstacle.x, obstacle.y, obstacle.width, obstacle.height);
	context.fillRect(floor.x, floor.y, floor.width, floor.height);
	context.drawImage(wood1, floor.x, floor.y, floor.width, floor.height);
	//Игрок
	context.fillStyle = 'rgba(0, 0, 0, 0.0)';
